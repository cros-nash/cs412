...
from .views import DeleteStatusMessageView, ShowAllView, ShowProfileView, CreateProfileView, CreateStatusMessageView, UpdateProfileView, UpdateStatusMessageView # our view class definition 
